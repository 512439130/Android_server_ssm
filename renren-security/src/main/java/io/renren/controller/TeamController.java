...
public class TeamController {
        ...
        /**
         * 查询社团新闻
         * http://localhost:8080/renren-security/team/yy_obtain_team_news
         */
        ...
        /**
         * 查询所有社团
         * http://localhost:8080/renren-security/team/yy_obtain_team
         */
         ...
         * 创建社团
         * 
         * http://localhost:8080/renren-security/team/yy_add_team?Json=(包含User的Json)
         */
        ...
        public int AddTeam(@RequestBody Team team) {
                ...
                if (team != null) {
                        ...
                        if (result == 1) {
                                ...
                                teamMember.setTeamMemberJoin(team.getTeamTime()); //4
                                //获取系统时间(方法2)
                                //Date nowTime = new Date();                                
                                if(teamMember != null){
                                        int result2 = teamService.addTeamMember(teamMember);  //给社团成员表添加社长
                                        if (result2 == 1) {
